...
while True:
    ...
    if (my_num > 0):
        ...
        elif(my_num > max_val): # devo inserire un altro elif per la condizione del massio, ossia se il mio numero inserito dopo il primo inserimento e' maggiore del max,
...
print(f"La media e': {avg_val:.3f}, il valore minimo e' {min_val}, mentre il valore massimo e' {max_val}")