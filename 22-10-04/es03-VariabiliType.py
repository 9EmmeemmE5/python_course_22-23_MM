...
# 1a="pippo" e' un errore perche non posso iniziare una variabile con un numero
# -var1="pippo" e' un errore perche non posso iniziare una variabile con un operatore
...
# e' buona norma iniziare la digitazione di una variabile con una lettera minuscola
# e non con una maiuscola
# e' buona cosa digitare in snake case typing con l'underscore

my_number = 1
type(my_number)
# imposto la variabile my number# come un int o float o una str;
# se nasce come float al massimo conterra' un int
# e non una str e cio' non ha alcun senso logico;
...
my_number = 4.4 + 1 
# eseguo l'addizione di un int 1 alla variabile e riottengo il float perche vince il float sull'int

my_number +=1 
# la funzione type restituisce la classe relativa a cosa e'
...
# se si dividono interi, altrimenti, dividendo float il type sara' float
...
div_std = 5 / 2
# restituisce un float ed e' la divisione normale
...
# lo shift e' più efficiente della moltiplicazione/divisione per 2 perche
...
type(my_condition) 
# restituisce una nuova classe di python, che e' il "bool" ossia e' un booleano
