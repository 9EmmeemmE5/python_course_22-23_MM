...
value_to_add = int(input("Definire quanti valori inserire..."))
my_list =[]

while len(my_list) != value_to_add:
...
#! plot dell'istogramma e print delle istanze (frequenza) di ogni classe
...
for element in my_list:
    if element <= sub_ints_bin_range[0]:
        sub_ints_freq.append(element)                                             #! appendere sottoliste per poi printarne il len
        my_list.pop(0)
    else:
        sub_ints_bin_range.pop(0)
