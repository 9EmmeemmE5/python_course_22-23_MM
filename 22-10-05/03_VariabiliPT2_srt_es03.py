...
print(my_str[0]) # con la [] vado a specificare cosa prendere dal contenitore, dalla  mia stringa: parto da 0, ossia il primo elemento che e' la h
...
"""
in python e' possibile usare indici negativi per pescare l'elemento della stringa corrispondente al modulo dell'indice negativo, ma da DX e non da SX, 
ma partendo da -1, per poi andare a SX ed avere indice -2, poi -3 ...
"""

my_str2 = "tre"
print(my_str2[2])
#my_str2[0] = "p" # Si e' verificata un'eccezione: TypeError 'str' object does not support item assignment
"""
non si puo' riassegnare un carattere di una stringa
"""
print(my_str2)
...
"""
print(input("inserisci una stringa...").lower()) # e' possibile programmare in maniera asincrona dando all'utente la possibilita' di scrivere una stringa
print("due" == "DUE") # restituisce un False perche non si e' normalizzata la coppia di stringhe in lower case od upper case
print("due".lower() == "DUE".lower()) # restituisce un True perche si e' normalizzata la coppia di stringhe in lowercase
"""
...
print(my_sub_str1) # ci si aspetta "sup" ma in realta' si va ad escludere l'ultimo carattere dell'indice finale dato dallo slice, ossia l'indice di stop
"""
