...
##from math import sin #from math import poi ctrl+space per richiamare i comandi contenuti in math che vengono presentati in un drop-down menu [log2 è un esempio]
...
"""
la differenza tra le due metodologie è che dalla prima io vado solamente a importare quello che serve, allora non ho bisogno di richamare il namespace;
