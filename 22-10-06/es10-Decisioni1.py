...
"""
Decisioni: se si verifica una condizione, allora esegui una data scelta, 
come un vero e proprio bivio, che puo' condurre ad un sotto-bivio e cosi' via, con la
speranza che poi alla fine si ricongiunga tutto in un unico punto finale.
Un determinato percorso, con le relative scelte possibili di livello
inferiore e cosi' via, si definisce "Branch" o ramo.
La variabile "if" ha solo 2 valori di verita', che possono essere o vero "True" o "False".
Possiamo avere anche delle logiche di altro tipo, codsiddette come "crispy" o spinose,
come le logiche "Fuzzy" od offuscate, come nel caso:

if(temp>37.5) restituisce un analisi con assegnazione di decisione parziale,
in quanto se avessi 37.6 avrei una data decisione, 
...
In python le parole chiavi riservate if ed else non possono assumere valori
come una normale variaibile, in quanto riservate
"""
